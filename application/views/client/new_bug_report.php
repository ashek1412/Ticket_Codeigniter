...
?>
	<div class="content">
		<div class="page-title-cont clearfix">
			<h3><?php echo $this->lang->line('text_create_new_bug_report');?></h3>
		</div>
			...
			<div class="col col-xs-12">
				<div class="cont clearfix">
					<div class="top clearfix">
						<h4 class="pull-left"><?php echo $this->lang->line('text_bug_report_details');?></h4>
					</div>
					...
					?>
						<div class="row min-bottom-margin">
							<div class="col col-md-6">
								<div class="form-group">
									...
									<span class="label_desc"><?php echo $this->lang->line('text_title_of_your_report');?></span>
							...
							<div class="col col-md-6">
								<div class="form-group">
									<label for="report_msg"><?php echo $this->lang->line('text_bug_report_content');?></label>
						...
						<input type="submit" name="submit" class="btn btn-strong-blue pull-right" value="<?php echo $this->lang->line('text_send_report');?>" />
					</form>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		$('document').ready(function() {
			...
			$('form[name=new-bug-report]').submit(function(evt) {
				...
				if(message == '') {
					evt.preventDefault();
					error('<?php echo $this->lang->line("text_Please_insert_the_ticket_message"); ?>', '.tinyeditor');
					return false;
				}
				if(message.length <= 10) {
					evt.preventDefault();
					error('<?php echo $this->lang->line("text_Bug_report_message_must_be_more_than_10_characters_long"); ?>', '.tinyeditor');
					return false;
				}
