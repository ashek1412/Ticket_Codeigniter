...
<body>
	<div id="container" class="ticket-submitted">
		...
		<div id="central-container" class="clearfix">
			<?php
			if(isset($req_activation) && $req_activation == true) {
			?>
			<h3 class="center">ACTIVATION NEEDED</h3>
			<p>
				Your account has been created!. We've sent you an email, please follow the instructions
				included to activate your account.
			</p>
			<?php
			}else{
			?>
			<h3 class="center">ACCOUNT CREATED!</h3>
			<p>
				Your account has been created. To login, you can go to the following URL:
			</p>
