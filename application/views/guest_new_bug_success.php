...
<body>
	<div id="container" class="ticket-submitted">
		...
		<div id="central-container" class="clearfix">
			<h3 class="center">BUG REPORT SUBMITTED!</h3>
			<p>
				Your bug report has been submitted, thank you! Please expect an email from us when we fix the bug :)
				<br />
				Also, if you want, you can check this bug status at:
			</p>
