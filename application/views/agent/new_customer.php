			...
			<div class="col col-xs-12">
				<div class="cont clearfix">
					...
					<?php
						...
						echo '<form method="POST" action="" name="new-customer">';
					?>
						<div class="row min-bottom-margin">
							<div class="col col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="license_num" name="license_num" value="<?php if(isset($_POST['license_num'])) echo $_POST['license_num']; ?>" />
                                </div>
                                <div class="form-group">
                                    <label for="subject">VIN number</label>
                                    <input type="text" id="vin_num" name="vin_num" value="<?php if(isset($_POST['vin_num'])) echo $_POST['vin_num']; ?>" />
                                </div>
                                <div class="form-group">
                                    <label for="subject">Displacement</label>
                                    <input type="text" id="displacement" name="displacement" value="<?php if(isset($_POST['displacement'])) echo $_POST['displacement']; ?>"  style="width: 150px;"/>
                                </div>
                                <div class="form-group">
                                    <label for="subject">Horsepower</label>
                                    <input type="text" id="horsepower" name="horsepower" value="<?php if(isset($_POST['horsepower'])) echo $_POST['horsepower']; ?>" style="width: 150px;"/>
                                </div>
                                <div class="form-group">
                                    <label for="subject">Year </label>
                                    <input type="text" id="year" class="date-picker-year" name="year" value="<?php if(isset($_POST['year'])) echo $_POST['year']; ?>" style="width: 50px;"/>
                                </div>
                                <div class="form-group">
                                    <label for="subject">Service Content </label>
                                    <input type="text" id="srv_content" name="srv_content" value="<?php if(isset($_POST['srv_content'])) echo $_POST['srv_content']; ?>" />
                                </div>
                                <div class="form-group">
                                    <label for="subject">Service Time </label>
                                    <input type="text" id="srv_time" name="srv_time" value="<?php if(isset($_POST['srv_time'])) echo $_POST['srv_time']; ?>" style="width: 150px;"/>
                                </div>
                                <div class="form-group">
                                    <label for="subject">Upgrade place </label>
                                    <input type="text" id="upd_place" name="upd_place" value="<?php if(isset($_POST['upd_place'])) echo $_POST['upd_place']; ?>" />
                                </div>
                                <div class="form-group">
	...
	<script type="text/javascript">
		...
		$('document').ready(function() {
           ...
           // $('#summernote').summernote();
			...
			$('form[name=new-customer]').submit(function(evt) {
