					...
					<div class="head clearfix">
						...
						<div class="pull-right">
							<div class="clearfix">
								...
								<div class="pull-right">
									<button class="btn btn-green besides-search" name="drop" data-drop="new-news" onclick="window.location.href='/magic/panel/admin/new-customer'">Add Customers</button>
								</div>
							</div>
						...
						<thead>
							...
							foreach($sorting as $sorted) {
								...
								if($sort == $sorted['c']) {
									...
									echo '<th width="'.$sorted['width'].'" data-sort="'.$base_url . 'panel/admin/all-customers/?sort='.$sorted['c'].'&w='.$direction.$s.'">';
									echo '<i class="fa fa-sort hid"></i>'.$arrow.$sorted['title'];
									echo '</th>';
								}else{
									echo '<th width="'.$sorted['width'].'" data-sort="'.$base_url . 'panel/admin/all-customers/?sort='.$sorted['c'].'&w=d'.$s.'">';
							...
							<tr>
								...
								<td>
									<?php
											...
											echo '<a href="'.$base_url.'panel/admin/customer/'.$row->id.'/delete" title="Delete Customer" name="delete-admin"><i class="fa fa-close"></i></a>';

									?>
									<a href="<?php echo $base_url; ?>panel/admin/customer/<?php echo $row->id; ?>/edit" title="Edit Customer" name="edit-customer"><i class="fa fa-pencil"></i></a>
								</td>
							</tr>
							<?php
							}
