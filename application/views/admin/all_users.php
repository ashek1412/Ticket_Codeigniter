						...
						<div class="pull-right">
							...
							?>
								...
								<form method="post" action="<?php echo $base_url; ?>panel/admin/new-user" name="new-user">
									...
									<?php
                                    $today=date('Y-m-d',strtotime('+15 year'));
                                    ...
                                    <label id="user-exp_date">Expires On</label>
                                     ...
                                     <input type="text" name="user-expdate" id="expdate" value="<?php echo $today;  ?>" />
	...
	<script type="text/javascript">
		...
		$('document').ready(function() {
			...
			$('form[name=new-user]').submit(function(evt) {
                ...
                var expdate = $('input[name=user-expdate]').val();
                ...
                if(expdate == '') {
                    evt.preventDefault();
                    error('Please insert a Expire Date', '[name=user-expdate]');
                    return false;
                }
				if(password == '') {
					evt.preventDefault();
