...
?>
				...
				<div class="row min-bottom-margin">
					<div class="col col-xs-12">
						<div class="cont clearfix">
							...
							<form method="POST" action="<?php echo $base_url; ?>panel/admin/bug-department/<?php echo $dpt_info->id; ?>/edit/action" name="edit-bdepartment">
								...
								<div class="form-group">
									...
									<span class="label_desc">Agents that will have access to this bug reports' department</span>
	...
	<script type="text/javascript">
		$('document').ready(function() {
			...
			$('form[name=edit-bdepartment]').submit(function(evt) {
